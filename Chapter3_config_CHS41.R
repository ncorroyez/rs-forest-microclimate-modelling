# ==============================================================================
# ============ VARIANT CHS41 : forcing air-T station-based (comme Ch1), tout le reste identique. Sortie séparée.
...
CFG_C3 <- list(
  # Local paths
  in_dir              = "in_files",
  out_dir             = "out_files/Chapter3_CHS41",
  forcing_file        = "out_files/MuSICA_in_CHS41-Blois_2021-station-hsbl-Rmerge.nc",  # CHS41 hybrid: Tair/RH/precip = CHS41 station, secondaries = ERA5, + MERRA-2 h_sbl
...
# ============ CHS41 variant overrides ============
# LAI preprocessing (Ch2bis output) is independent of macro reference — REUSE from ERA5 run
CFG_C3$lai_prep_dir <- file.path("out_files/Chapter3", "lai_prep")
