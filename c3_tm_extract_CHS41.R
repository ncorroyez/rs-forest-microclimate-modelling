...
# Out: out_files/Chapter3/tables/perplot_dtmax_conventions_CHS41.csv
...
WC<-file.path(CFG_C3$out_dir,"nc")
...
fwrite(ALL,file.path(OUT,"perplot_dtmax_conventions_CHS41.csv"))
cat(sprintf("wrote %s (%d rows)\n",file.path(OUT,"perplot_dtmax_conventions_CHS41.csv"),nrow(ALL)))
