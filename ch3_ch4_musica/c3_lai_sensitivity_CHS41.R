# ==============================================================================
# CHS41 variant of c3_lai_sensitivity.R (original untouched). Same synthetic
# canopy and same LAI sweep, run under the CHS41 hybrid forcing that every other
# Chapter 3 number now uses. The original figure dates from June 2026 and was
# produced under in_files/FR-Blo_2021.nc.
...
write.csv(R, "/home/corroyez/Documents/NC_Full/manuscripts/ch3/tables/Table0c_lai_sensitivity_CHS41.csv", row.names=FALSE)
...
ggsave("/home/corroyez/Documents/NC_Full/manuscripts/ch3/figures/Fig0_lai_sensitivity_CHS41.png", g, width=10, height=4.2, dpi=150)
cat("\nDONE\n")
