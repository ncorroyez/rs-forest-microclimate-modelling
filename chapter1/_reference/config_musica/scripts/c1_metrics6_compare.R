...
load_ver <- function(ver) rbindlist(lapply(list.files(sprintf("out_files/Chapter3/tables/metrics6_%s",ver),
...
fwrite(imp, "out_files/Chapter3/tables/tab_metrics6_compare.csv")
...
ggsave("out_files/Chapter3/figures/FigCmp_metrics6_v320_v323iter.png", p, width=10, height=6, dpi=200, bg="white")
