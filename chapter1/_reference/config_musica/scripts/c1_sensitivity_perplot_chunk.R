...
# Out (incremental): out_files/Chapter3/tables/sensitivity_perplot/part_<chunk>.csv
# ==============================================================================
...
NCDIR   <- "out_files/Chapter3/nc_sensitivity_perplot"; dir.create(NCDIR, recursive = TRUE, showWarnings = FALSE)
BASEDIR <- "out_files/Chapter3/nc_shapley2x"            # reuse coalition 1111 as baseline
...
pdir <- "out_files/Chapter3/tables/sensitivity_perplot"; dir.create(pdir, showWarnings = FALSE, recursive = TRUE)
