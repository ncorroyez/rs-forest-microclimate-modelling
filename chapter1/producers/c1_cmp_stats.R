...
fwrite(ST, "out_files/Chapter1/tables/tab_stats_v320_v323.csv")
fwrite(tests, "out_files/Chapter1/tables/tab_stats_tests_v320_v323.csv")
...
ggsave("out_files/Chapter1/figures/FigCmp_stats_skill_v320_v323iter.png", f1, width=8.5,height=4.5,dpi=200,bg="white")
...
ggsave("out_files/Chapter1/figures/FigCmp_stats_error_v320_v323iter.png", f2, width=10,height=4.8,dpi=200,bg="white")
for (f in c("FigCmp_stats_skill_v320_v323iter.png","FigCmp_stats_error_v320_v323iter.png"))
  file.copy(file.path("out_files/Chapter1/figures",f), "Chapitre1/comparaison_versions/figures/", overwrite=TRUE)
