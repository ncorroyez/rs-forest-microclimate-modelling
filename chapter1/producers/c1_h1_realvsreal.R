...
# Out: out_files/Chapter1/tables/h1_realvsreal_part<chunk>of<K>.csv (combine after)
# ==============================================================================
...
NCDIR <- "out_files/Chapter1/nc_h1_realvsreal"; dir.create(NCDIR, recursive=TRUE, showWarnings=FALSE)
...
of <- if (K==1L) file.path(odir,"h1_realvsreal.csv") else file.path(odir, sprintf("h1_realvsreal_part%02dof%02d.csv", CHUNK, K))
