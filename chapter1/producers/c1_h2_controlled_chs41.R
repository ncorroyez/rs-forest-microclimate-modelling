...
#
# Reads :
#         out_files/H2_controlled_topheavy_chs41/LAI1s<lai>/musica_out_<profile>.nc
#           the 42 cached runs. MuSICA runs ONLY for a NetCDF that is missing or < 1 kB.
# Writes: outputs/figures_pipeline/annex/fig_h2_controlled_topheavy_chs41.{png,pdf}
#          + tab_h2_controlled_topheavy_chs41.csv
# ==============================================================================
...
if (LINEAGE == "chapter") {
  SIMDIR <- here::here("out_files/H2_controlled_topheavy_chs41")
  ...
  CFG$forcing_file <- normalizePath("out_files/MuSICA_in_CHS41-Blois_2021-station-hsbl-Rmerge.nc", mustWork=TRUE)
...
write_csv(D, file.path(OUT, "tab_h2_controlled_topheavy_chs41.csv"))
...
ggsave_article(file.path(OUT, "fig_h2_controlled_topheavy_chs41"), p, 7.5, 5.5)
...
write_csv(opt, file.path(OUT, "tab_h2_optimum_by_lai_chs41.csv"))
cli::cli_alert_success("Saved fig_h2_controlled_topheavy_chs41 (png + pdf) + table")
