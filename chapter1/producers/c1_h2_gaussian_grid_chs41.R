...
HMAX<-25; FCOVER<-0.87
MU_GRID<-c(0.30,0.40,0.50,0.60,0.70)
SIGMA_GRID<-c(0.12,0.18,0.24,0.30,0.36)
...
NCDIR<-"out_files/H2_gaussian_grid_chs41"; dir.create(NCDIR,recursive=TRUE,showWarnings=FALSE)
...
fwrite(R,"out_files/Chapter1/tables/h2_gaussian_grid_chs41.csv")
