...
run_one <- function(ver, prow, tag, lai, hmax, fcov, ladf=make_lad_real) {
  cfg <- CFG_V[[ver]]; d <- sprintf("out_files/Chapter1/nc_archetypes/%s", gsub("[^A-Za-z0-9]","",ver))
...
fwrite(res, "out_files/Chapter1/tables/tab_sensitivity_archetypes.csv")
...
out <- "out_files/Chapter1/figures/FigCmp_sensitivity_archetypes_v320_v323iter.png"
