...
# Out: out_files/Chapter1/tables/sensitivity_perplot_iter/part_<chunk>.csv
# ==============================================================================
...
NCDIR <- "out_files/Chapter1/nc_sensitivity_perplot_iter"; dir.create(NCDIR, recursive = TRUE, showWarnings = FALSE)
...
pdir <- "out_files/Chapter1/tables/sensitivity_perplot_iter"; dir.create(pdir, showWarnings = FALSE, recursive = TRUE)
