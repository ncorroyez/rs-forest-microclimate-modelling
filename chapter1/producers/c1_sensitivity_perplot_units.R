...
# Out: out_files/Chapter1/tables/sensitivity_perplot_units/part_<chunk>.csv
# ==============================================================================
...
WC<-TRUE; source("R/wind_correction.R"); .forc<-FORC
...
NCDIR<-"out_files/Chapter1/nc_sensitivity_perplot_units"; dir.create(NCDIR,recursive=TRUE,showWarnings=FALSE)
...
pdir<-"out_files/Chapter1/tables/sensitivity_perplot_units"; dir.create(pdir,recursive=TRUE,showWarnings=FALSE)
