# ==============================================================================
# VARIANTE CHS41 de c1_sensitivity_units_extract2.R (original intact).
# Lit les NetCDF produits sous le forcage CHS41 sans correction de vent et
# ecrit une table distincte. Rien n'est ecrase.
# ==============================================================================
...
FORC<-"out_files/MuSICA_in_CHS41-Blois_2021-station-hsbl-Rmerge.nc"; NCDIR<-"out_files/Chapter1/nc_sensitivity_perplot_units_CHS41"
...
fwrite(X,"out_files/Chapter1/tables/sensitivity_perplot_units_v2_CHS41.csv")

# --- REGRESSION CHECK against the original single-metric table --------------------
O<-rbindlist(lapply(list.files("out_files/Chapter1/tables/sensitivity_perplot_units_CHS41","part_.*csv$",full.names=TRUE),fread),fill=TRUE)
