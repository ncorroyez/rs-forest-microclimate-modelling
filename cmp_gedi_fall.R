# ==============================================================================
# cmp_gedi_fall.R — Chapter 4: does the GEDI-constrained autumn limb improve the
...
# Writes NC_Full/manuscripts/ch4/tables/Table15_c4_gedifall.csv (+ _boot.csv).
#   Rscript cmp_gedi_fall.R
# ==============================================================================
...
SC<-c("DYN_ALS_GEDIFALL","DYN_S2_ANNUAL_FIX","CONST_ALS","STATIC_ALS","DYN_S2_ATBD")
...
for(w in names(WINDOWS)){
  ...
  a<-PP$DYN_ALS_GEDIFALL[id_plot%in%with_series];b<-PP[["DYN_S2_ANNUAL_FIX"]][id_plot%in%with_series]
...
cat("\n=== paired bootstrap GEDIFALL - ANNUAL (47 plots with series) ===\n");print(bt)
fwrite(res,file.path(TAB,"Table15_c4_gedifall.csv"))
fwrite(bt,file.path(TAB,"Table15b_c4_gedifall_boot.csv"))
