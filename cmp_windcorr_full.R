...
UNI<-file.path(CFG_C3$out_dir,"nc_genuine53"); WC<-file.path(CFG_C3$out_dir,"nc_genuine53_windcorr")
SCEN<-basename(list.dirs(WC,recursive=FALSE))
...
fwrite(out,"/home/corroyez/Documents/NC_Full/manuscripts/ch3/tables/windcorr_full_compare.csv")
cat("\nWROTE chapter3_S2_LAI/tables/windcorr_full_compare.csv\n")
