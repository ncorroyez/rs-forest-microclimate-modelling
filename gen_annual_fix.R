# ==============================================================================
# gen_gedi_fall_musica.R — Chapter 4: scenario DYN_S2_ANNUAL_FIX.
...
ts_gedifall <- setNames(lapply(df$pid, function(p) {
  ...
  lai <- a$lai
  fall <- rep(FALSE, length(a$doy))  # FIX run: series untouched
