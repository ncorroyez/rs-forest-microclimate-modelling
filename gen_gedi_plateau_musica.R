# ==============================================================================
# gen_gedi_fall_musica.R — Chapter 4: scenario DYN_ALS_GEDIPLATEAU.
...
ts_gedifall <- setNames(lapply(df$pid, function(p) {
  ...
  lai <- a$lai
  lai[a$doy >= 180 & a$doy < 250] <- mag   # GEDI-informed flat summer core
