"""
Corroyez_MEB2026_v11.pptx → v12.pptx.

1. Drop the '16-configuration factorial' framing on slide 8 notes
   → option A : "We run 5 simulations per plot (REF + 4 LOO variants)"
2. Re-insert the regenerated forward-selection figure on slide 10
   (axes swapped : observed on X, simulated on Y)
"""
from pathlib import Path
from pptx import Presentation
from pptx.util import Pt, Inches

SRC = Path("/home/corroyez/Downloads/1Papers/files/Corroyez_MEB2026_v11.pptx")
DST = Path("/home/corroyez/Downloads/1Papers/files/Corroyez_MEB2026_v12.pptx")
...
# ============================================================================
# 1) Slide 8 notes — option A : 5 simulations per plot, no "16" mention
# ============================================================================
...
# ============================================================================
# 2) Slide 10 — replace forward selection picture (regenerated with x=obs y=sim)
# ============================================================================
slide10 = prs.slides[9]
pics = [(j, sh) for j, sh in enumerate(slide10.shapes) if sh.shape_type == 13]
# Pick the largest = forward-selection figure (the corner logo is small)
...
if pics_sorted and FIG_FORWARD.exists():
    ...
    print(f"Replaced forward-selection figure on slide 10")

# Also update slide 10 notes to reflect the axis swap (obs on x)
...
"y-axis. Same sign convention on both axes: negative means the canopy "
"buffers. We start from the uniform baseline, then add traits one at a "
"time in the LOO order: fCover, LAI, Hmax, finally LAD = REF.\n"
"\n"
...
"buffering spans about 2 °C, observed range about 7 °C. This is the "
"glass-ceiling: MuSICA gets the ordering, not the magnitude.\n"
"\n"
"Notable: ρ is negative for the first two steps (fCover, fCover+LAI), "
